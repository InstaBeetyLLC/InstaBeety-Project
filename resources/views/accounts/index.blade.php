                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">
                            <a class=""  href="{{ route('accounts.create') }}">
                            ...
                            <table class="table table-striped table-bordered table-hover dataTables-example ">
                                ...
                                @foreach($accounts as $account)
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <a class="btn btn-xs btn-info" href="{{ route('accounts.show', $account->id) }}"><i class="glyphicon glyphicon-eye-open"></i> View</a>
                                            <a class="btn btn-xs btn-primary" href="{{ route('accounts.edit', $account->id) }}"><i class="glyphicon glyphicon-edit"></i> Edit</a>
        ...
        $(document).ready(function () {
            $('.dataTables-example').DataTable({
                ...
                buttons: [
                    {extend: 'copy'},
                    {extend: 'csv'},
                    {extend: 'excel', title: 'Account'},
                    {extend: 'pdf', title: 'Account'},
