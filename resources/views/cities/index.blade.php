                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">
                            <a class=""  href="{{ route('cities.create') }}">
                                create a city <i class="glyphicon glyphicon-plus"></i>
                            </a>
                        </div>
                    </div>
                            ...
                            <table class="table table-striped table-bordered table-hover dataTables-example ">
                                ...
                                @foreach($cities as $city)
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <a class="btn btn-xs btn-info" href="{{ route('cities.show', $city->id) }}"><i class="glyphicon glyphicon-eye-open"></i> View</a>
                                            <a class="btn btn-xs btn-primary" href="{{ route('cities.edit', $city->id) }}"><i class="glyphicon glyphicon-edit"></i> Edit</a>
                                            <form action="{{ route('cities.destroy', $city->id) }}" method="POST" style="display: inline;" onsubmit="if(confirm('Delete? Are you sure?')) { return true } else {return false };">
