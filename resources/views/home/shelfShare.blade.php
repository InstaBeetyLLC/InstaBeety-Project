...
@foreach($products->get()->groupBy('brand_id') as $brand)
    @php
        $brands_names[]= MyHelper::getBrandName($brand[0]->brand_id);
        $brands_ids[]= $brand[0]->brand_id;

         //sub loop for store
         $tmp[]=MyHelper::getBrandName($brand[0]->brand_id);
     foreach ($stores_ids as $store_id){
        ...
        $brand_weight=DB::table('products')->where('brand_id', $brand[0]->brand_id)
                ...
                <div class="col-md-4">
                    <div class="form-group" id="data_5">
                        ...
                        <div class="form-group">
                            <button class="btn btn-warning btn-search" id="today" type="submit">Search
                            </button>
                        </div>
                    </div>
                </div>
