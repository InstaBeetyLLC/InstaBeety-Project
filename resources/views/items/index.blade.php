                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">
                            <a class=""  href="{{ route('items.create') }}">
                            ...
                            <table class="table table-striped table-bordered table-hover dataTables-example ">
                                ...
                                @foreach($items as $item)
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <a class="btn btn-xs btn-info" href="{{ route('items.show', $item->id) }}"><i class="glyphicon glyphicon-eye-open"></i> View</a>
                                            <a class="btn btn-xs btn-primary" href="{{ route('items.edit', $item->id) }}"><i class="glyphicon glyphicon-edit"></i> Edit</a>
