                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">
                            <a class=""  href="{{ route('product_shares.create') }}">
                               create new one <i class="glyphicon glyphicon-plus"></i>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover dataTables-example ">
                                ...
                                <tbody>
                                @foreach($product_shares as $product_share)
                                    <tr>
                                        <td>{{$product_share->id}}</td>
                                        <td>{{$product_share->name}}</td>
                                        <td>{{$product_share->brand->name}}</td>

                                        <td>
                                            @if(isset($product_share->store_id))
                                                {{$product_share->store->name}}
                                            @endif
                                        </td>

                                        <td>{{$product_share->quantity}}</td>
                                        <td class="text-right">
                                            <a class="btn btn-xs btn-primary" href="{{ route('product_shares.show', $product_share->id) }}"><i class="glyphicon glyphicon-eye-open"></i> View</a>
                                            <a class="btn btn-xs btn-warning" href="{{ route('product_shares.edit', $product_share->id) }}"><i class="glyphicon glyphicon-edit"></i> Edit</a>
        ...
        $(document).ready(function () {
            $('.dataTables-example').DataTable({
                ...
                buttons: [
                    {extend: 'copy'},
                    {extend: 'csv'},
                    {extend: 'excel', title: 'Shelf Share'},
                    {extend: 'pdf', title: 'Shelf Share'},
